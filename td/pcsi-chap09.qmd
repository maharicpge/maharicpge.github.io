...
# Cours {-}
[**Chapitre 09 : Primitives et équations différentielles linéaires**](pcsi-chap09.qmd)

# Navigation {-}
::: {.chap-nav}
[TD 08 : Fonctions usuelles, fonctions convexes](pcsi-chap08.qmd){.prev}
[Menu PCSI](pcsi.qmd){.home}
[TD 10 : Calcul matriciel et systèmes d'équations linéaires](pcsi-chap10.qmd){.next}
:::

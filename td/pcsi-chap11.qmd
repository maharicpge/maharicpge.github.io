...
# Cours {-}
[**Chapitre 11 : Polynômes et fractions rationnelles**](pcsi-chap11.qmd)

# Navigation {-}
::: {.chap-nav}
[TD 10 : Calcul matriciel et systèmes linéaires](pcsi-chap10.qmd){.prev}
[Menu PCSI](pcsi.qmd){.home}
[TD 12 : Développements limités, calcul asymptotique](pcsi-chap12.qmd){.next}
:::

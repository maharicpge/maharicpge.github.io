---
title: "TD — Vocabulaire ensembliste et méthodes de raisonnement"
...
4. $\forall x\, \forall y,\; R(x,y)$ équivaut à $\forall y\, \forall x,\; R(x,y)$, mais $\forall x\, \exists y,\; R(x,y)$ n'équivaut pas en général à $\exists y\, \forall x,\; R(x,y)$. Donner un contre-exemple.
:::
...
- (3) Supposer $p_1, \ldots, p_n$ premiers. Poser $N = p_1 \cdots p_n + 1$.
...
3. $f$ est injective $\iff \forall A, B \in \mathcal{P}(E),\; f(A \cap B) = f(A) \cap f(B)$.
:::
...
# Cours {-}
[**Chapitre 01 : Vocabulaire ensembliste et méthodes de raisonnement**](../cours/tsi1-chap01.qmd)

# Navigation {-}
::: {.chap-nav}
[Menu TSI1](tsi1.qmd){.home}
[TD 02 : Nombres complexes](tsi1-chap02.qmd){.next}
:::

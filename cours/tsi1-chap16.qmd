...
**TSI 1re année — Chapitre 16.** Fonctions en escalier, construction de l'intégrale, propriétés, sommes de Riemann, théorème fondamental, IPP, Taylor avec reste intégral, changement de variable, intégration numérique.
...
# Document en PDF {-}
📝 [**Chapitre 16 : Intégration des fonctions continues sur un segment**](PDF/tsi1-chap16.pdf)

# Voir TD {-}
✍️ [**TD 16 : Intégration des fonctions continues sur un segment**](../td/tsi1-chap16.qmd)

## Navigation {-}

::: {.chap-nav}

[Chapitre 15 : Représentations matricielles](tsi1-chap15.qmd){.prev}
[Menu TSI1](tsi1.qmd){.home}
[Chapitre 17 : Dénombrement](tsi1-chap17.qmd){.next}

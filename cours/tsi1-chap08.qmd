...
**TSI 1re année — Chapitre 08.** exp, ln, puissances, trigonométrie circulaire et hyperbolique, fonctions réciproques, convexité, inégalité de Jensen, applications.
...
# Document en PDF {-}
📝 [**Chapitre 08 : Fonctions usuelles, fonctions convexes**](PDF/tsi1-chap08.pdf)

# Voir TD {-}
✍️ [**TD 08 : Fonctions usuelles, fonctions convexes**](../td/tsi1-chap08.qmd)

## Navigation {-}

::: {.chap-nav}

[Chapitre 07 : Fonctions de la variable réelle, dérivation](tsi1-chap07.qmd){.prev}
[Menu TSI1](tsi1.qmd){.home}
[Chapitre 09 : Primitives et équations différentielles linéaires](tsi1-chap09.qmd){.next}

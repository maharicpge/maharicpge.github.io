---
title: "Cours – Espaces préhilbertiens réels. Endomorphismes d'un espace euclidien"
...
On définit la **norme euclidienne** associée à un produit scalaire $\langle \cdot, \cdot \rangle$ par :
...
où $a_0, \ldots, a_n$ sont des réels deux à deux distincts.
...
Pour toute forme linéaire $\varphi$ sur $E$, il existe un et un seul vecteur $x$ tel que :
$$\forall y \in E, \quad \varphi(y) = \langle x, y \rangle$$

:::

## Adjoint d'un endomorphisme

::: {.theorem-definition title="(Adjoint d'un endomorphisme)"}
...
::: {.proposition-definition title="(Endomorphisme auto-adjoint)"}
...
::: {.proposition title="(Valeurs propres d'une isométrie)"}
...
::: {.theorem title="(Version matricielle du théorème spectral)"}
...
# Document en PDF {-}
📝 [**Chapitre 08 : Espaces préhilbertiens réels. Endomorphismes d'un espace euclidien**](PDF/psi-chap08.pdf)

# Voir TD {-}
✍️ [**TD 08 : Espaces préhilbertiens réels. Endomorphismes d'un espace euclidien**](../td/psi-chap08.qmd)

## Navigation {-}

::: {.chap-nav}

[Chapitre 07 : Séries entières](psi-chap07.qmd){.prev}
[Menu PSI](psi.qmd){.home}
[Chapitre 09 : Intégrales dépendant d'un paramètre](psi-chap09.qmd){.next}

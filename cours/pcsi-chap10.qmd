...
# Document en PDF {-}
📝 [**Chapitre 10 : Calcul matriciel et systèmes d'équations linéaires**](PDF/pcsi-chap10.pdf)

# Voir TD {-}
✍️ [**TD 10 : Calcul matriciel et systèmes d'équations linéaires**](../td/pcsi-chap10.qmd)

## Navigation {-}

::: {.chap-nav}

[Chapitre 09 : Primitives et équations différentielles linéaires](pcsi-chap09.qmd){.prev}
[Menu PCSI](pcsi.qmd){.home}
[Chapitre 11 : Polynômes et fractions rationnelles](pcsi-chap11.qmd){.next}
